...
public class KafkaReceiveService {
	...
	private final IAudioVideoConversionService audioVideoConversionService;
	...
	public void consume(ConversionRequest request) throws Exception {
		...
		kafkaProducerService.sendMessage(KAFKA_TRANSCRIPT_AUDIO_TOPIC, transcriptionRequest);
	}
